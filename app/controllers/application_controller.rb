class ApplicationController < Sinatra::Base
    ...
    # NEW:
    # NOTE: This is using the 'post' keyword so that we can create a new customer pet
    post "/customer_pets" do
        customer_pet = CustomerPet.find(name: params[:name], age: params[:age], location: params[:location], notes: params[:notes])
        customer_pet.to_json()
    end
end